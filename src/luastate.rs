#![allow(non_camel_case_types, non_snake_case, dead_code, clippy::wildcard_imports)]
...
type lua_Alloc = unsafe extern "C-unwind" fn(ud: *mut c_void, ptr: *mut c_void, osize: usize, nsize: usize) -> *mut c_void;
